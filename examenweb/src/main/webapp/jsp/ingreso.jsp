...
<body>
	...
	<div class="container">
		<div class="row d-flex justify-content-center">
			<div class="col-md-6">
				<h2 class="text-center m-4">Registro de Ingreso</h2>
				<form method="post"
					action="RegistrarMovimientosController?ruta=guardarIngreso">
					<div class="mb-3">
						<label for="categoria-ingreso" class="form-label">Categoría
							...
							<c:forEach items="${cuentasIngreso}" var="cuentaIngreso">
								<option value="${cuentaIngreso.id}">
									${cuentaIngreso.nombre}</option>
							</c:forEach>
						</select>
					</div>
					<div class="mb-3">
